...
def test_symbols():
    symbols = SymbolTable()
    # scope 0 level 0
    build_in_printf = symbols.set_symbol(Symbol(name="printf"))
    build_in_sizeof = symbols.set_symbol(Symbol(name="sizeof"))
    ...
    assert symbols.get_symbol("printf") is build_in_printf
    symbols.leave_scope()
    # scope 1 level 1
    assert symbols.scope_id == 1
    assert symbols.level == 1
    ...
    assert symbols.get_symbol("printf") is build_in_printf
    assert symbols.get_symbol("sizeof") is build_in_sizeof
    symbols.leave_scope()
    # scope 1 level 1
    assert symbols.scope_id == 1
    assert symbols.level == 1
